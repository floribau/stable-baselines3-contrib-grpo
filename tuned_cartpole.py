...
TRAIN_DEFAULT_PPO = True
TRAIN_TUNED_PPO = False
TRAIN_FAIR_TUNED_PPO = False

PLOT_DEFAULT_PPO = True
PLOT_TUNED_PPO = True
...
tuned_env = make_vec_env(ENV_NAME, n_envs=8)
...
tuned_ppo_model = PPO(
    ...
    n_steps=32,
    batch_size=256,
    gae_lambda=0.8,  # TODO what is gae_lambda?
    gamma=0.98,
    n_epochs=20,
    ent_coef=0.0,
    learning_rate=LinearSchedule(start=0.001, end=0.0, end_fraction=1.0),
    clip_range=LinearSchedule(start=0.2, end=0.0, end_fraction=1.0),
)
