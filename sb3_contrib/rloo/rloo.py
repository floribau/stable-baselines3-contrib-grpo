...
from sb3_contrib.common.buffers import BaseGroupBuffer, DeepSeekOutcomeGroupBuffer, SupervisionType
...
class RLOO(GRPO):
    ...
    :param group_rollout_buffer_class: Group Rollout buffer class to use. If ``None``, it will be automatically selected. 
        In RLOO, this well be DeepSeekOutcomeGroupBuffer by default.
